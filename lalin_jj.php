                            ...
                            ?>
                              ...
                              <?php }
                                ...
                                while($data_lalintransaksi = mysqli_fetch_array($lalin_transaksitinggi)){
                                  ...
                                  $data_gerbang_terbuka_lalin = mysqli_query($connect, "SELECT * FROM transaksi_tinggi WHERE id_cabang='$idcabang' AND id_subgardu = '1'");
                                  $total1 = 0;
								  while ($num = mysqli_fetch_array($data_gerbang_terbuka_lalin)) {
								  $total1 += $num['nilai'];}
                                  $data_gerbang_masuk_lalin = mysqli_query($connect, "SELECT * FROM transaksi_tinggi WHERE id_cabang='$idcabang' AND id_subgardu = '2'");
                                  $total2 = 0;
								  while ($num = mysqli_fetch_array($data_gerbang_masuk_lalin)) {
								  $total2 += $num['nilai'];}
                                  $data_gerbang_keluar_lalin = mysqli_query($connect, "SELECT * FROM transaksi_tinggi WHERE id_cabang='$idcabang' AND id_subgardu = '3'");
                                  $total3 = 0;
								  while ($num = mysqli_fetch_array($data_gerbang_keluar_lalin)) {
								  $total3 += $num['nilai'];}
                                  $data_gerbang_terbuka_gto_lalin = mysqli_query($connect, "SELECT * FROM transaksi_tinggi WHERE id_cabang='$idcabang' AND id_subgardu = '4'");
                                  $total4 = 0;
								  while ($num = mysqli_fetch_array($data_gerbang_terbuka_gto_lalin)) {
								  $total4 += $num['nilai'];}
                                  $data_gerbang_masuk_gto_lalin = mysqli_query($connect, "SELECT * FROM transaksi_tinggi WHERE id_cabang='$idcabang' AND id_subgardu = '5'");
                                  $total5 = 0;
								  while ($num = mysqli_fetch_array($data_gerbang_masuk_gto_lalin)) {
								  $total5 += $num['nilai'];}
                                  $data_gerbang_keluar_gto_lalin = mysqli_query($connect, "SELECT * FROM transaksi_tinggi WHERE id_cabang='$idcabang' AND id_subgardu = '6'");
                                  $total6 = 0;
								  while ($num = mysqli_fetch_array($data_gerbang_keluar_gto_lalin)) {
								  $total6 += $num['nilai'];}
                                  $data_epass_lalin = mysqli_query($connect, "SELECT * FROM transaksi_tinggi WHERE id_cabang='$idcabang' AND id_subgardu = '7'");
                                  $total7 = 0;
								  while ($num = mysqli_fetch_array($data_epass_lalin)) {
								  $total7 += $num['nilai'];}
                              }
