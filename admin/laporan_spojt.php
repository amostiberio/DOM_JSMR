          ...
          <div class="">
            ...
            <div class="">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-table" value="<?php echo $idcabang; ?>" hidden></i> Table <small>Data Capex SPOJT Semua Cabang  </small></h2>
                  ...
                  <div class="title_right">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-5 form-group pull-right top_search" style="margin-top:10px;">
                      ...
                      <ul role="menu" class="dropdown-menu pull-right">
                        <li><a href="downloadlaporanspojt.php?triwulan=<?php echo $nilaiTriwulan;?>&tahun=<?php echo $nilaiTahun;?>" > Unduh Excels <img src='xls.png' alt="XLSX" style="width:20px"></a>
                       </li>
                      ...
                      <table id="datatable-keytable"  class="table table-striped table-bordered " class="centered">
                        <thead>
                          ...
                          <tr>
                            ...
                            <?php
                            if($nilaiTahun > 0 ){
                              $listTW = mysqli_query($connect, "SELECT * FROM capex_realisasi, sub_program WHERE sub_program.id_sp = capex_realisasi.id_sp AND stat_twrl ='1' AND capex_realisasi.jenis ='spojt' AND sub_program.jenis='capex' AND capex_realisasi.tahun='$nilaiTahun' ");
                            }else{
