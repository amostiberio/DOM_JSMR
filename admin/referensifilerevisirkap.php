          ...
          <div class="">
            ...
            <div class="">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-table"></i> Table <small>Data Revisi RKAP <?php echo $namacabang; ?> </small></h2>
                    <div class="clearfix"></div>
                  </div>
                  ...
                  <div class="x_content">
					<table id="datatable-keytable"  class="table table-striped table-bordered text-center">
						...
						<tbody>
						<?php
						$rolereferensi = mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM referensifile_role WHERE jenis = 'Revisi'"));
		...
		<div class="modal-header">
		  ...
		  <form action="unggah.php" method="post" id="demo-form2" data-parsley-validate enctype="multipart/form-data" class="form-horizontal form-label-left">
			...
			<div class="modal-footer">
			  ...
			  <button type="submit" class="btn btn-primary" id="nama" name="tambahReferensiFileRevisiRKAP">Simpan</button>
			</div>
		 </form>
	  </div>
	</div>
