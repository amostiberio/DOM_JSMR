...
if(isset($_GET['id_referensi'])) 
{

$id    = $_GET['id_referensi'];

$result = mysqli_query($connect,"SELECT nama_file, type_file, content, size_file FROM referensi_file WHERE id_referensi = '$id'") or die('Error, query failed');
list($name, $type, $content, $size) = mysqli_fetch_array($result);
