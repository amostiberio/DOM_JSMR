    ...
    <div class="menu_section">
        <h3>General</h3>
            <!-- Menu Monitoring Beban dan Capex -->
              ...
              <!-- Menu Monitoring Beban dan Capex -->
                  <ul class="nav side-menu">
                   <li><a><i class="fa fa-sitemap"></i> Beban dan Capex <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a>Beban<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                   ...
                   <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-book"></i> Laporan Bulanan <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                        ...
                        <li><a href="statuslaporanbulanan.php">Status Input Laporan Bulanan <span class="fa"></span></a> </li>
                        <li><a href="laporanrealisasi.php">Management Laporan Realisasi <span class="fa"></span></a> </li>
                  ...
                  <ul class="nav side-menu">
                    <li><a><i class="fa fa-book"></i> Laporan KPI <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                        ...
                        <li><a href="csi.php">Customer Satisfication Index</a></li>
