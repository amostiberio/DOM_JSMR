...
header("Content-Disposition: attachment; filename=Data Customer Satisfication Index ".$nilaiTriwulan.".xls");
header("Pragma : no-cache");
header("Expires :0"); $i=0;
?>

 <div align="center"> <p>Data Laporan Beban BPT <?php if($nilaiTriwulan == 0){?> Semua Triwulan <?php  }else {echo $nilaiTriwulan;} ?> </p></div>
