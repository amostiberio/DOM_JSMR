                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					<table id="datatable-keytable"  class="table table-striped table-bordered text-center">
						...
						<tbody>
						<?php
						$rolereferensi = mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM referensifile_role WHERE jenis = 'RKAP'"));
		...
		<div class="modal-header">
		  ...
		  <form action="unggah.php" method="post" id="demo-form2" data-parsley-validate enctype="multipart/form-data" class="form-horizontal form-label-left">
			...
			<div class="modal-footer">
			  ...
			  <button type="submit" class="btn btn-primary" id="nama" name="tambahReferensiFileRKAP">Simpan</button>
			</div>
		 </form>
	  </div>
	</div>
