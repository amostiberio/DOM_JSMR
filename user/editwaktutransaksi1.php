...
//proses edit waktu transaksi semester 1
		if(isset($_POST['editwaktutransaksis1'])){
			$idgerbangterbukas1 = anti_injection($_POST['edit_idgerbangterbukas1']);
			$idgerbangmasuks1 = anti_injection($_POST['edit_idgerbangmasuks1']);
			$idgerbangkeluars1 = anti_injection($_POST['edit_idgerbangkeluars1']);
			$idgerbangterbukagtos1 = anti_injection($_POST['edit_idgerbang_gto_terbukas1']);
			$idgerbangmasukgtos1 = anti_injection($_POST['edit_idgerbang_gto_masuks1']);
			$idgerbangkeluargtos1 = anti_injection($_POST['edit_idgerbang_gto_keluars1']);
			$idpanjangantrians1 = anti_injection($_POST['edit_idpanjang_antrians1']);

			$datagerbangterbukas1 = anti_injection($_POST['edit_gerbangterbukas1']);
			$datagerbangmasuks1 = anti_injection($_POST['edit_gerbangmasuks1']);
			$datagerbangkeluars1 = anti_injection($_POST['edit_gerbangkeluars1']);
			$datagerbangterbukagtos1 = anti_injection($_POST['edit_gerbang_gto_terbukas1']);
			$datagerbangmasukgtos1 = anti_injection($_POST['edit_gerbang_gto_masuks1']);
			$datagerbangkeluargtos1 = anti_injection($_POST['edit_gerbang_gto_keluars1']);
			$datapanjangantrians1 = anti_injection($_POST['edit_panjang_antrians1']);
...
//proses delete waktu transaksi semester 1
		if(isset($_POST['deletewaktutransaksi'])){
			...
			$idsemester1 = anti_injection($_POST['edit_idsemester1']);
			$idtws1 = anti_injection($_POST['edit_idtws1']);
...
//proses edit waktu transaksi semester 2
		if(isset($_POST['editwaktutransaksis2'])){
			$idgerbangterbukas2 = anti_injection($_POST['edit_idgerbangterbukas2']);
			$idgerbangmasuks2 = anti_injection($_POST['edit_idgerbangmasuks2']);
			$idgerbangkeluars2 = anti_injection($_POST['edit_idgerbangkeluars2']);
			$idgerbangterbukagtos2 = anti_injection($_POST['edit_idgerbang_gto_terbukas2']);
			$idgerbangmasukgtos2 = anti_injection($_POST['edit_idgerbang_gto_masuks2']);
			$idgerbangkeluargtos2 = anti_injection($_POST['edit_idgerbang_gto_keluars2']);
			$idpanjangantrians2 = anti_injection($_POST['edit_idpanjang_antrians2']);

			$datagerbangterbukas2 = anti_injection($_POST['edit_gerbangterbukas2']);
			$datagerbangmasuks2 = anti_injection($_POST['edit_gerbangmasuks2']);
			$datagerbangkeluars2 = anti_injection($_POST['edit_gerbangkeluars2']);
			$datagerbangterbukagtos2 = anti_injection($_POST['edit_gerbang_gto_terbukas2']);
			$datagerbangmasukgtos2 = anti_injection($_POST['edit_gerbang_gto_masuks2']);
			$datagerbangkeluargtos2 = anti_injection($_POST['edit_gerbang_gto_keluars2']);
			$datapanjangantrians2 = anti_injection($_POST['edit_panjang_antrians2']);
...
//proses delete waktu transaksi semester 2
		if(isset($_POST['deletewaktutransaksis2'])){
			$idgerbang = anti_injection($_POST['edit_idgerbang']);
			$idsemester2 = anti_injection($_POST['edit_idsemester2']);
			$idtws2 = anti_injection($_POST['edit_idtws2']);
