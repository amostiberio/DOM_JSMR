...
if($nilaiTahun > 0 ){
  header("Content-Disposition: attachment; filename=Data Laporan Capex SPJT ".$nilaiTahun.".xls");
}else{
  header("Content-Disposition: attachment; filename=Data Laporan Capex SPJT .xls");
...
?>
 ...
 <div align="center"> <p>Data Laporan Beban SPJT Tahun  <?php if($nilaiTahun >0 ) { echo $nilaiTahun;} ?> <?php if($nilaiTriwulan == 0){?> Semua Triwulan <?php  }else ?> Triwulan <?php {echo $nilaiTriwulan;} ?> </p></div>
              ...
              <table border="1"  id="datatable-keytable"  class="table table-striped table-bordered text-center">
                        <thead>
                          ...
                          <tr  bgcolor="#ddebf7">
                            ...
                            <?php
                             if($nilaiTahun >0 ){
                               $listTW = mysqli_query($connect, "SELECT * FROM capex_realisasi, sub_program WHERE sub_program.id_sp = capex_realisasi.id_sp AND stat_twrl ='1'  AND sub_program.id_cabang = '$idcabang' AND capex_realisasi.jenis ='spjt' AND sub_program.jenis='capex' AND capex_realisasi.tahun = '$nilaiTahun'  ");
                            }else {
              ...
              while($datalistTW = mysqli_fetch_array($listTW)){
                ...
                $datasubprogramkerja= mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM sub_program WHERE id_sp = '$idspklist'"));
                                //realisasi
                $datatwreal1 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM capex_realisasi WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrl = '1' AND jenis ='spjt'"));
                $datatwreal2 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM capex_realisasi WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrl = '2' AND jenis ='spjt'"));
                $datatwreal3 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM capex_realisasi WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrl = '3' AND jenis ='spjt'"));
                $datatwreal4 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM capex_realisasi WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrl = '4' AND jenis ='spjt'"));
                                //rkap
                $datatwrc1 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM capex_rencana WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrc = '1' AND jenis ='spjt'"));
                $datatwrc2 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM capex_rencana WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrc = '2' AND jenis ='spjt'"));
                $datatwrc3 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM capex_rencana WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrc = '3' AND jenis ='spjt'"));
                $datatwrc4 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM capex_rencana WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrc = '4' AND jenis ='spjt'"));
