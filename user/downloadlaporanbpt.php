...
if($nilaiTahun > 0 ){
  ...
  header("Content-Disposition: attachment; filename=Data Laporan Beban BPT Cabang ".$namacabang.".xls");
}
header("Pragma : no-cache");
header("Expires :0"); $i=0;
?>

 <div align="center"> <p>Data Laporan Beban BPT <?php if($nilaiTahun > 0 ) ?>Tahun <?php{ echo $nilaiTahun;} ?> <?php if($nilaiTriwulan == 0){?> Semua Triwulan <?php  }else{ ?> Triwulan <?php echo $nilaiTriwulan;} ?> </p></div>
