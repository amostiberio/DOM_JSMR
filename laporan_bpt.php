          ...
          <div class="">
            ...
            <div class="">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-table" value="<?php echo $idcabang; ?>" hidden></i> Table <small>Laporan Data Beban BPT Cabang <?php echo $namacabang; ?> </small></h2>
                      ...
                      <table id="datatable-keytable"  class="table table-striped table-bordered " class="centered">
                        <thead>
                          ...
                          <tr>
                            ...
                            <?php
                            if($nilaiTahun >0 ){
                              $listTW = mysqli_query($connect, "SELECT * FROM beban_realisasi, sub_program WHERE sub_program.id_sp = beban_realisasi.id_sp AND stat_twrl ='1'  AND sub_program.id_cabang = '$idcabang' AND beban_realisasi.jenis ='bpt' AND sub_program.jenis='beban' AND tahun = '$nilaiTahun' ");
                            }else {
