          ...
          <div class="">
            ...
            <div class="">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-table"></i> Table <small>Data Beban Rencana BPT Cabang <?php echo $namacabang; ?> </small></h2>
                        ...
                        <form action="editdatabeban.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						  ...
						  <div class="col-md-6">
							  ...
							  <div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="rkap">Revisi RKAP</label>
