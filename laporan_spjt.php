          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Laporan Capex SPJT Cabang <?php echo $namacabang; ?></h3>
              </div>
                  ...
                  <div class="title_right">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-5 form-group pull-right top_search" style="margin-top:10px;">
                      ...
                      <ul role="menu" class="dropdown-menu pull-right">
                       <li><a href="downloadlaporanspjt.php?triwulan=<?php echo $nilaiTriwulan;?>&tahun=<?php echo $nilaiTahun;?>" > Unduh Excels <img src='xls.png' alt="XLSX" style="width:20px"></a>
                       </li>
